...
.suggestion:hover { border-color: var(--border-strong); transform: translateY(-2px); }
.icon {
  display: grid;
  width: 43px;
  height: 43px;
...
b { display: block; margin-bottom: 10px; font-size: 15px; font-weight: 650; color: var(--text-primary); }
small { display: block; font-size: 14px; line-height: 1.75; color: var(--text-muted); }
@media (max-width: 960px) {
  .empty { padding-top: 50px; }
  .suggestions { grid-template-columns: 1fr; }
  .suggestion { min-height: 150px; }
